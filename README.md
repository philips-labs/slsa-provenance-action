...
```sh
docker run philipssoftware/slsa-provenance:v0.8.1
```
...
```sh
docker run ghcr.io/philips-labs/slsa-provenance:v0.8.1
```
  ...
  provenance:
    ...
    steps:
      - name: Generate provenance for Release
        uses: philips-labs/slsa-provenance-action@v0.8.1
        with:
          command: generate
          subcommand: files

...
```sh
docker run philipssoftware/slsa-provenance:v0.7.3-draft
```
...
```sh
docker run ghcr.io/philips-labs/slsa-provenance:v0.7.3-draft
```
  ...
  provenance:
    ...
    steps:
      - name: Generate provenance for Release
        uses: philips-labs/slsa-provenance-action@v0.7.3-draft
        with:
          command: generate
          subcommand: files

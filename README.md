...
```sh
docker run philipssoftware/slsa-provenance:v0.6.2-draft
```
...
```sh
docker run ghcr.io/philips-labs/slsa-provenance:v0.6.2-draft
```
  ...
  provenance:
    ...
    steps:
      - name: Generate provenance for Release
        uses: philips-labs/slsa-provenance-action@v0.6.2-draft
        with:
          command: generate
          subcommand: files
